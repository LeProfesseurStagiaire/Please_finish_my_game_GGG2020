...
var dead_sentence = ["t'es mort !", "haha, t'es mourru ?", "tu fais semblant ?","essaye encore","t'y arriveras jamais !","tu ne fais aucun effort ! ","LOL !!","MDR..."]
...
func _on_time_timeout():
	if can_count == true:
		...
		if time >= goal_time:
			...
			global.wave_win_this_turn = true
			if global.wave_selected == global.wave_unlocked:
